...
def handle_location():
    ...
    longitude = 0xFFFF
    altitude = 0xFFFF
    velocity = 0.1.to_bytes(2, byteorder='big')
    ...
    response_data = warning_mark + status_flag + latitude + longitude+ altitude + velocity + direction + time
    message_id = 0x0200
...
def startClient():
    ...
    print(send_message("52.205.68.170", 1234, req_data))
